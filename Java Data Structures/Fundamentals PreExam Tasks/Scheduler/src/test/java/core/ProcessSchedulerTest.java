...
public class ProcessSchedulerTest {
    ...
    @Test
    public void testAddAfterShouldReturnProperInfo() {
        Scheduler scheduler = new ProcessScheduler();
        scheduler.add(new ScheduledTask(13, "test_description"));
        scheduler.add(new ScheduledTask(42, "test_description"));
        scheduler.add(new ScheduledTask(69, "test_description"));

        Task test = new ScheduledTask(112, "inserted_test");
        scheduler.insertAfter(42, test);

        Task current = scheduler.process();
        current = scheduler.process();
        current = scheduler.process();

        assertEquals(112, current.getId());

    }

    @Test
    public void testAddBeforeShouldReturnProperInfo() {
        Scheduler scheduler = new ProcessScheduler();
        scheduler.add(new ScheduledTask(13, "test_description"));
        scheduler.add(new ScheduledTask(42, "test_description"));
        scheduler.add(new ScheduledTask(69, "test_description"));
        ...
        Task test = new ScheduledTask(112, "inserted_test");
        scheduler.insertBefore(42, test);
    ...
    @Test
    public void testRescheduleWithProperValues() {
        Scheduler scheduler = new ProcessScheduler();
        scheduler.add(new ScheduledTask(13, "test_description"));
        scheduler.add(new ScheduledTask(42, "test_description"));
        scheduler.add(new ScheduledTask(69, "test_description"));
        scheduler.add(new ScheduledTask(112, "test_description"));
        scheduler.add(new ScheduledTask(911, "test_description"));

        Task task1 = scheduler.find(112);
        Task task2 = scheduler.find(42);
        scheduler.reschedule(task1, task2);
