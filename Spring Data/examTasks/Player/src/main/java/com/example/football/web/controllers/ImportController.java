...
public class ImportController extends BaseController {
    ...
    @PostMapping("/stats")
    public ModelAndView importStatsConfirm() throws JAXBException, IOException, jakarta.xml.bind.JAXBException {
    ...
    @PostMapping("/players")
    public ModelAndView importPlayersConfirm() throws JAXBException, FileNotFoundException, IOException, jakarta.xml.bind.JAXBException {
