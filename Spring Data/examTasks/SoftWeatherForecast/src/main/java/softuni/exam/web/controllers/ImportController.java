...
public class ImportController extends BaseController {
    ...
    public ModelAndView importForecastsConfirm() throws JAXBException, IOException, jakarta.xml.bind.JAXBException {
    ...
    @PostMapping("/offers")
    public ModelAndView importOffersConfirm() throws JAXBException, FileNotFoundException, IOException, jakarta.xml.bind.JAXBException {
        System.out.println(this.forecastService.importForecasts());
