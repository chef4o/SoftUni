...
public class AdminController extends BaseController {
    ...
    public ModelAndView getAdminPanel(ModelAndView modelAndView,
        ...
        UserAdminViewDto currentUser = getCurrentUser(session);
    ...
    public ModelAndView getEditAdminPanel(ModelAndView modelAndView,
        ...
        return super.view("admin-panel-edit", modelAndView);
    }

    @PostMapping ("/edit")
    public ModelAndView postEditAdminPanel(ModelAndView modelAndView,
                                          HttpSession session) {
    ...
    private UserAdminViewDto getCurrentUser(HttpSession session) {
        return userService
                .getById(Long.valueOf(session.getAttribute(USER_ID).toString()))
